...
parser = argparse.ArgumentParser(
    description="Get sentences that contain variations of specified word"
)
parser.add_argument("word", help="Word to search for")
parser.add_argument("pos", nargs="?", default="", help="part of speech")
parser.add_argument(
    "count", nargs="?", default=3, type=int, help="Max sentences to retrieve"
)
parser.add_argument(
    "--strict",
    action="store_true",
    help="Only show sentences matching the specified pos",
)
